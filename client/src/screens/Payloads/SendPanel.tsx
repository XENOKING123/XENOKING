 ...
 * "looks like our payload" / "no XENO TOOL signature found — use only
...
function probeMessage(code: string, isPs5upload: boolean): string {
  switch (code) {
    ...
    case "payload_probe_detected":
      return "This is a XENO TOOL payload.";
    case "payload_probe_no_signature":
      return isPs5upload
        ? "XENO TOOL payload detected."
        : "No XENO TOOL signature found — use only if you trust this payload.";
    default:
