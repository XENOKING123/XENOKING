          ...
          >
            <p className="mb-4 text-sm text-[var(--color-muted)]">
              {tr(
                ...
                `The XENO TOOL helper is a small program your PS5 runs in memory to accept uploads. Sent over port ${PS5_LOADER_PORT}; it takes a few seconds for the PS5 to respond once the bytes arrive.`,
              )}
            </p>
