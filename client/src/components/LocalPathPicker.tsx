          ...
          <div className="flex flex-col items-center gap-3 px-5 py-8 text-center">
            ...
            <p className="text-xs text-[var(--color-muted)]">
              {tr(
                "picker_grant_hint",
                undefined,
                "To upload a game folder or .zip, XENO TOOL needs permission to read your files. Tap below, enable “Allow access to manage all files”, then come back and tap Retry.",
              )}
            </p>
