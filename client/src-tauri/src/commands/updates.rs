...
// XENO update channel — points at XENOKING's own GitHub releases. Until a
// release with `latest.json` is published there, the fetch 404s, the check
// errors, and NO "update available" toast is shown (only a real newer version
